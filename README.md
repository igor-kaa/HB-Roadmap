...
Месячные мощности департаментов задаются на странице. По умолчанию каждый департамент получает 20 mdays/месяц, а одна задача может расходовать не более 1 mday в рабочий день.
